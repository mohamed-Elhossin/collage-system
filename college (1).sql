...
INSERT INTO `news` (`id`, `news`, `image`, `pdf`, `adminId`, `created_at`, `updated_at`) VALUES
(4, 'adsfsdafdsa', '11111.jpg', 'Mohamed El-hossin.pdf', 1, '2021-06-30 23:17:12', '2021-06-30 23:17:12');
...
--
ALTER TABLE `news`
  ADD CONSTRAINT `news_ibfk_1` FOREIGN KEY (`adminId`) REFERENCES `users` (`id`);
